...
const MachineIdModal: React.FC<MachineIdModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Redirection vers l'URL de paiement fournie
    const baseUrl = "https://posaiform-ld6bhcl9n-elkebirs-projects.vercel.app";
            ...
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                <h3 className="text-xl leading-6 font-bold text-slate-900 dark:text-white" id="modal-title">
                  Activer votre Licence POS.AI
                </h3>
                <div className="mt-2">
                  <p className="text-sm text-slate-500 dark:text-slate-400">
                    Saisissez l'identifiant unique de votre machine pour procéder au paiement et recevoir votre clé d'activation instantanément.
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="mt-6">
                  ...
                  <div className="bg-amber-50 dark:bg-amber-900/30 rounded-lg p-3 mb-6 flex items-start border border-amber-100 dark:border-amber-900/50">
                    <HelpCircle className="w-5 h-5 text-amber-600 dark:text-amber-500 mr-2 flex-shrink-0 mt-0.5" />
                    <p className="text-xs text-amber-800 dark:text-amber-300">
                      Vous trouverez cet ID dans l'application POS.AI : <br/>
                      <strong>Menu Principal {'>'} Paramètres {'>'} Licence</strong>
                    </p>
                  </div>

                  <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                    <Button type="submit" fullWidth className="sm:ml-3">
                      Valider et Payer (149€)
